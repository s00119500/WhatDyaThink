...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        <tr>
            ...
            <td><asp:TextBox runat="server" ID="txtbxName" />
            </td>
        </tr>
        <tr>
            <td><asp:Label Text="Password" runat="server" /></td>
            <td><asp:TextBox runat="server" ID="txtbxPassword" />
            </td>
        </tr>
        <tr>
            <td><asp:Button Text="Login" ID="btnLogin" OnClick="btnLogin_Click" runat="server" /></td>
        </tr>
        <tr>
